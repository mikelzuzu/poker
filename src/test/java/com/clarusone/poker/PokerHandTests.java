...
public class PokerHandTests {
    ...
    @Test
    public void two_pairs_tie() {
        compareHands(TIE, "QD QS AS AH 2C", "2S AD QH QC AC");
    }

    @Test
    public void pair_beats_a_highest_number() {
        compareHands(WIN, "2H 2H 5C 6H 7H", "AS 2H 3H 4S 5C");
    }

    @Test
    public void straight_flush_beats_straight() {
        compareHands(LOSS, "2S 3H 4H 5S 6C", "3C 4C 5C 6C 2C");
    }

    @Test
    public void full_house_with_same_cards_tie() {
        compareHands(TIE, "2S AH 2H AS AC", "2C AH 2D AD AC");
    }

    @Test
    public void three_of_a_kind_with_same_cards_tie() {
        compareHands(TIE, "AS AH 6D AD 5C", "AH AC 5H 6H AS");
    }

    @Test(expected =  IllegalArgumentException.class)
    public void hand_with_invalid_card() {
        compareHands(WIN, "2Z 2H 5C 6H 7H", "AS 2H 3H 4S 5C");
    }
